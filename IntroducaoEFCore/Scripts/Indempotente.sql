...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20210825234231_PrimeiraMigracao')
BEGIN
...
BEGIN
    ...
    VALUES (N'20210825234231_PrimeiraMigracao', N'5.0.9');
END;
GO
